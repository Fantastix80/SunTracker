...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvTemperature.setText(items.get(position).getTemperature());
        holder.tvMaxTemperature.setText(items.get(position).getMaxDegree());
        holder.tvMinTemperature.setText(items.get(position).getMinDegree());
